    ...
    <div class="modal-dialog modal-  modal-" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('masterdata.cabang.action')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-merge input-group-alternative">
                            ...
                            <textarea class="form-control" placeholder="Alamat Lengkap" name="alamat" id="alamat"><?php echo e(old('alamat')); ?></textarea>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\portal-hrd\resources\views/modal/modalcabang.blade.php ENDPATH**/ ?>