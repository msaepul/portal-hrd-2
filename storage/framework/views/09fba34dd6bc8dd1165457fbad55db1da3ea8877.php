<div class="modal fade" id="modal-loker" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
    <div class="modal-dialog modal-  modal-" role="document">
      <div class="modal-content">

        <div class="modal-header bg-primary">
          <h6 class="modal-title text-white bold" id="modal-title-default">Masukan Loker</h6>
...
<?php /**PATH C:\xampp\htdocs\portal-hrd\resources\views/modal/modaloker.blade.php ENDPATH**/ ?>