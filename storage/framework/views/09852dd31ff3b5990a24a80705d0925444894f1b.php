...
<?php $__env->startSection('title', 'Edit-loker'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('loker.edit.action', $loker->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="example3cols1Input" placeholder="Cabang"
                                    name="id_cabang2" id="id_cabang" value="<?php echo e(getPTCabang($loker->id_cabang)); ?>" readonly>
                                ...
                                <select class="form-control" id="exampleFormControlSelect1" name="id_dept" id="id_dept">
                                    <?php $__currentLoopData = $depts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($d->id); ?>"
                                            <?php if($d->id === $loker->id_dept): ?> selected <?php endif; ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="start_date" class="form-control" id="example3cols1Input"
                                    value="<?php echo e($loker->start_date); ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="end_date" class="form-control" id="example3cols2Input"
                                    value="<?php echo e($loker->end_date); ?>">
                                <!-- Isi dengan nilai awal dari data yang ingin diedit -->
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="custom-control custom-checkbox mb-3 ml-3">
                                        <input class="custom-control-input" id="gender" name="gender"
                                            ...
                                            <?php if($loker->gender == 1): ?> checked <?php endif; ?>>
                                    ...
                                    <div class="custom-control custom-checkbox mb-3 ml-3">
                                        <input class="custom-control-input" id="date_birth" name="date_birth"
                                            type="checkbox" value="1"
                                            <?php if($loker->date_birth == 1): ?> checked <?php endif; ?>>
                                    ...
                                    <div class="custom-control custom-checkbox mb-3 ml-3">
                                        <input class="custom-control-input" id="country" name="country"
                                            type="checkbox" value="1"
                                            <?php if($loker->country == 1): ?> checked <?php endif; ?>>
                                ...
                                <div class="row">
                                    ...
                                    <div class="custom-control custom-checkbox mb-3 ml-3">
                                        <input class="custom-control-input" id="profile_image" name="profile_image"
                                            type="checkbox" value="1"
                                            <?php if($loker->profile_image == 1): ?> checked <?php endif; ?>>
                                    ...
                                    <div class="custom-control custom-checkbox mb-3 ml-3">
                                        <input class="custom-control-input" id="resume" name="resume"
                                            type="checkbox" value="1"
                                            <?php if($loker->resume == 1): ?> checked <?php endif; ?>>
                                    ...
                                    <div class="custom-control custom-checkbox mb-3 ml-3">
                                        <input class="custom-control-input" id="cv" name="cv"
                                            type="checkbox" value="1"
                                            <?php if($loker->cv == 1): ?> checked <?php endif; ?>>
                                    ...
                                    <div class="custom-control custom-checkbox mb-3 ml-3">
                                        <input class="custom-control-input" id="tac" name="tac"
                                            type="checkbox" value="1"
                                            <?php if($loker->tac == 1): ?> checked <?php endif; ?>>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var initialContent1 = '<?php echo $loker->desc_job; ?>';
            var initialContent2 = '<?php echo $loker->require_job; ?>';
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\portal-hrd\resources\views/loker/editloker.blade.php ENDPATH**/ ?>