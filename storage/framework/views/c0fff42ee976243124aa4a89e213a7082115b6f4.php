<?php $__env->startSection('title', 'Master Data Cabang'); ?>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <?php echo $__env->make('modal.modalcabang', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="table-responsive py-4">
                        <table class="table table-flush" id="datatable-buttons">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $cabang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($index + 1); ?></td>
                                        <td><?php echo e($cab->pt); ?></td>
                                        <td><?php echo e($cab->keterangan); ?></td>
                                        <td><?php echo e($cab->alamat); ?></td>
                                        <td><?php echo e($cab->nama_cabang); ?></td>
                                        <td>
                                            <?php if($cab->status == 1): ?>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('Cabang.updateStatus', ['id' => $cab->id, 'model' => 'Cabang'])); ?>"
                                                class="btn btn-sm btn-warning">
                                                <i class="fas fa-ban" style="color: #ffffff;"></i>
                                            </a>
                                            <!-- Form untuk menghapus data loker -->
                                            <form action="<?php echo e(route('masterdata.cabang.delete', $cab->id)); ?>" method="POST"
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\portal-hrd\resources\views/masterdata/cabang.blade.php ENDPATH**/ ?>