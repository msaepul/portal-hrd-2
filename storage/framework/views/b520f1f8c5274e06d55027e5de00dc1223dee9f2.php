...
<style>
    ...
    .header {
        background-image: url('<?php echo e(asset('assets/img/brand/pdl.jpg')); ?>');
    ...
    <nav id="navbar-main" class="navbar navbar-horizontal navbar-main navbar-expand-lg navbar-dark bg-transparent">
        <div class="container d-flex align-items-center">
            <a class="navbar-brand" href="#">
                <img src="<?php echo e(asset('assets/img/brand/logo jordan.png')); ?>" style="width:15%; height:auto;">
            </a>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <?php if(auth()->guard()->guest()): ?>
                            <a class="nav-link" href="<?php echo e(route('login')); ?>" class="btn btn-primary">
...
<?php /**PATH C:\xampp\htdocs\portal-hrd\resources\views/layout/landinglayout.blade.php ENDPATH**/ ?>